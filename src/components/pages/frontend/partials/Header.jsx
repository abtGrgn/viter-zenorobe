  ...
  return (
    ...
    >
      <div className="container">
        <div
          className={`${
            scrollPosition > 150 ? "!text-black" : "text-white"
        ...
        >
          ...
          <Link
            to="/"
            className={`text-xl uppercase font-bold ${isOpen && "text-black "}`}
          >
            Zanerobe
          </Link>
          ...
          <ul
            className={`flex gap-5  group-hover:text-black ${
              isOpen && "text-black "
            }`}
          >
